...
if TYPE_CHECKING:
    from ...tl.types import TypeMessageRange, TypeType, TypeX
...
class InitConnectionRequest(TLRequest):
    ...
    def __init__(self, api_id: int, device_model: str, system_version: str, app_version: str, system_lang_code: str, lang_pack: str, lang_code: str, query: 'TypeX'):
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(api_id=_api_id, device_model=_device_model, system_version=_system_version, app_version=_app_version, system_lang_code=_system_lang_code, lang_pack=_lang_pack, lang_code=_lang_code, query=_query)
