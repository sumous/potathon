...
class SentCode(TLObject):
    ...
    def __init__(self, type: 'TypeSentCodeType', phone_code_hash: str, next_type: Optional['TypeCodeType']=None, timeout: Optional[int]=None):
        """
        Constructor for auth.SentCode: Instance of either SentCode, SentCodeCaptcha.
        """
        self.type = type
...
class SentCodeCaptcha(TLObject):
    CONSTRUCTOR_ID = 0xb594a934
    SUBCLASS_OF_ID = 0x6ce87081

    def __init__(self, captcha_token: str, captcha_type: int, captcha_para: 'TypeDataJSON'):
        """
        Constructor for auth.SentCode: Instance of either SentCode, SentCodeCaptcha.
        """
        self.captcha_token = captcha_token
        self.captcha_type = captcha_type
        self.captcha_para = captcha_para
    ...
    def to_dict(self):
        return {
            ...
            'captcha_para': self.captcha_para.to_dict() if isinstance(self.captcha_para, TLObject) else self.captcha_para
        }

    def _bytes(self):
        return b''.join((
            b'4\xa9\x94\xb5',
            self.serialize_bytes(self.captcha_token),
            struct.pack('<i', self.captcha_type),
            self.captcha_para._bytes(),
        ))

    @classmethod
    def from_reader(cls, reader):
        _captcha_token = reader.tgread_string()
        _captcha_type = reader.read_int()
        _captcha_para = reader.tgread_object()
        return cls(captcha_token=_captcha_token, captcha_type=_captcha_type, captcha_para=_captcha_para)
